...
public class TubeTool : MonoBehaviour, ITool {
	...
	public void AddTube(string id, List<Vector3> verts, List<int> tris, List<Vector2> uvs) {
	...
	public ICommand EndStroke() {
		...
		TubeCommand tc = new TubeCommand(tubeId, this, _preview.Vertices, _preview.Tris, _preview.Uvs);
		_preview.Reset();
		tc.Execute();
